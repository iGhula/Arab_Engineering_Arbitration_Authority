...
import ArabArbitrationCenterSection from '../components/ArabArbitrationCenterSection';

const ArabArbitrationCenterPage = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
...
export default ArabArbitrationCenterPage;
